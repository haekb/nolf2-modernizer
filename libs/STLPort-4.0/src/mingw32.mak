...
# CXXFLAGS_RELEASE_dynamic = $(CXXFLAGS_COMMON) -O2 -shared -D__STL_USE_DYNAMIC_LIB
CXXFLAGS_RELEASE_dynamic = $(CXXFLAGS_COMMON) -O2 -D__STL_USE_DYNAMIC_LIB

CXXFLAGS_DEBUG_static = $(CXXFLAGS_COMMON) -g
CXXFLAGS_DEBUG_dynamic = $(CXXFLAGS_COMMON) -g -shared -D__STL_USE_DYNAMIC_LIB

CXXFLAGS_STLDEBUG_static = $(CXXFLAGS_DEBUG_static) -D__STL_DEBUG
CXXFLAGS_STLDEBUG_dynamic = $(CXXFLAGS_DEBUG_dynamic) -D__STL_DEBUG -shared -D__STL_USE_DYNAMIC_LIB
...
${RESFILE}: stlport.rc
	windres -O coff --define COMP=${COMP} --define BUILD=Release -o $(RELEASE_OBJDIR_dynamic)$(PATH_SEP)stlport.o stlport.rc

${RESFILE_debug}: stlport.rc
	windres -O coff --define COMP=${COMP} --define BUILD=Debug -o $(DEBUG_OBJDIR_dynamic)$(PATH_SEP)stlport.o stlport.rc

${RESFILE_stldebug}: stlport.rc
	windres -O coff --define COMP=${COMP} --define BUILD=DebugSTL -o $(STLDEBUG_OBJDIR_dynamic)$(PATH_SEP)stlport.o stlport.rc

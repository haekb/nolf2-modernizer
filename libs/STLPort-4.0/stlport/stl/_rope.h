    ...
    case _Base::_S_substringfn:
      {
        ...
        __STL_ASSERT(__start_pos + __req_len <= this->_M_size._M_data)
        __STL_ASSERT(_M_start + this->_M_size._M_data <= _M_base->_M_size._M_data)
...
__ITERATOR_CATEGORY(const _Rope_iterator<_CharT,_Alloc>&) {  return random_access_iterator_tag();}
template <class _CharT, class _Alloc>
inline _CharT* __VALUE_TYPE(const _Rope_iterator<_CharT,_Alloc>&) { return 0; }
template <class _CharT, class _Alloc>
inline ptrdiff_t* __DISTANCE_TYPE(const _Rope_iterator<_CharT,_Alloc>&) { return 0; }
template <class _CharT, class _Alloc>
inline random_access_iterator_tag
__ITERATOR_CATEGORY(const _Rope_const_iterator<_CharT,_Alloc>&) { return random_access_iterator_tag(); }
template <class _CharT, class _Alloc>
inline _CharT* __VALUE_TYPE(const _Rope_const_iterator<_CharT,_Alloc>&) { return 0; }
template <class _CharT, class _Alloc>
inline ptrdiff_t* __DISTANCE_TYPE(const _Rope_const_iterator<_CharT,_Alloc>&) { return 0; }
#endif

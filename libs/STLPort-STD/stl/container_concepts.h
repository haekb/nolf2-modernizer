...
_ForwardContainer_requirement_violation(_ForwardContainer __c) {
  ...
  _EqualityComparable_concept_specification<_ForwardContainer>::_EqualityComparable_requirement_violation(__c);
  // Refinement of LessThanComparable
  _LessThanComparable_concept_specification<_ForwardContainer>::_LessThanComparable_requirement_violation(__c);
  // Requirements on Iterators

...
inline forward_iterator_tag __STL_CALL __ITERATOR_CATEGORY(const _Slist_iterator_base&) { return forward_iterator_tag(); }
#endif
...
__value_type(const _Slist_iterator<_Tp, _Traits>&) { return (_Tp*)0; }

...
copy .\built\debug\ServerRes\TO2\SRes.dll "D:\Games\No One Lives Forever 2 - Dev\NewGame\"
copy .\built\debug\ClientFxDll\ClientFx.fxd "D:\Games\No One Lives Forever 2 - Dev\NewGame\"
echo "Finished!"
pause
...
//****************************************************************************************
    ...
    inline char *strcpy(const char *str) {
...
__inline void check_create_pointers() {
    if (ptrs == NULL) 
	{
...
__inline void check_delete_pointers() {
...
void CInterfaceDatabase::VersionError(const char *interface_name) {
    ...
    //save the name
    version_check_interface_name = strcpy(interface_name);
}
...
void __declspec(dllexport) SetMasterDatabase(CInterfaceDatabase *new_database) {
    //check parameters
...
//****************************************************************************************
    ...
    template <class C>
    CPointerTrackedTarget<C>::operator CPointerTracked<C> *&() {
        return tracked_pointers;
    }

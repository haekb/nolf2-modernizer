...
Used for: Text and UI.  */
		virtual int8		GetDefCharScreenWidth() = 0;
...
Used for: Text and UI.  */
		virtual int8		GetDefCharScreenHeight() = 0;
...
Used for: Text and UI.  */
		virtual int8		GetCharTexWidth() = 0;
...
Used for: Text and UI.  */
		virtual int8		GetCharTexHeight() = 0;
...
Used for: Text and UI.  */
		virtual void		SetDefCharWidth(int8 width) = 0;
...
Used for: Text and UI.  */
		virtual void		SetDefCharHeight(int8 height) = 0;
...
Used for: Text and UI.  */
		virtual void		SetDefSpacingH(int8 hspacing) = 0;
...
Used for: Text and UI.  */
		virtual void		SetDefSpacingV(int8 vspacing) = 0;
